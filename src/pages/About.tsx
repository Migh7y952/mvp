...
const About = () => {
    ...
    <>
      ...
      <div className="flex justify-center items-center">
        <div
          ...
          style={{
            backgroundImage: `url(${Company})`, // Replace with the correct path to your image in the assets folder
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div className="relative bg-white shadow-lg p-6 rounded-lg mt-16 md:mt-0">
      <div className="absolute w-32 h-32 -top-16 left-1/2 transform -translate-x-1/2 bg-center bg-cover rounded-full" 
           style={{ backgroundImage: `url(${Beto})` }}>
      </div>
      <div className="mt-20">
        <h3 className="text-xl font-semibold text-center">Ernestine Peng</h3>
        <p className="text-center text-sm text-gray-600">Vision & Financials</p>
        <p className="mt-4 text-gray-700 text-center">
          Ernestine steers the vision and financial direction of Roomie HQ, ensuring the company’s future is bright and sustainable.
        </p>
      </div>
    </div>
    ...
    <div className="relative bg-white shadow-lg p-6 rounded-lg mt-8 md:mt-0 transform translate-y-8">
      ...
      <div className="mt-20">
        <h3 className="text-xl font-semibold text-center">Roberto Torres</h3>
        <p className="text-center text-sm text-gray-600">Tech Lead</p>
        <p className="mt-4 text-gray-700 text-center">
          Roberto is the tech mastermind behind Roomie HQ, turning ideas into reality and driving innovation within the platform.
        </p>
      </div>
    </div>
    ...
    <div className="relative bg-white shadow-lg p-6 rounded-lg mt-24 md:mt-0">
      ...
      <div className="mt-20">
        ...
        <p className="mt-4 text-gray-700 text-center">
          Nice leads our marketing efforts, creating strategies that connect Roomie HQ with the right audience at the right time.
        </p>
      </div>
    </div>
  </div>
